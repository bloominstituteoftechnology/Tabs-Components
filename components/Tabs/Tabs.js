...
class TabsLink {
  ...
  select() {
    ...
    console.log(`${this.element} tabslink selected`);
  }
  ...
  deselect() {
   ...
   console.log(`${this.element} tabslink deselected`);
  }
}
...
class TabsItem {
  ...
  select() {
    ...
    console.log(`${this.element} tabsitem selected`);
  }

  deselect() {
    // Remove a class named "tabs-item-selected" from the element 
    this.element.classList.remove('tabs-item-selected');
    console.log(`${this.element} tabsitem deselected`);
