...
class TabsLink {
  ...
  constructor(element, parent) {
    ...
    this.tabsItem = parent.getTab('this.tabs-item[data-tab ="${this.element}"]');
    // Create a new TabsItem object that passes in a tabsItem value that you just created above
    //this.box = document.querySelector(`.box[data-btn="${this.buttonData}"]`);
    this.tabsItem;
...
tabs = Array.from(tabs).map(tabsref => new Tabs(tabsref));