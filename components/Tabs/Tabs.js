class Tabs {
  constructor(element) {
    ...
    // This step will map over the array creating new TabsLink class instances of each link.  No need to update anything here, just study what is going on.  
...
class TabsItem {
  ...
  select() {
    ...
    this.element = this.element.addClass("tabs-item-selected");
  }
  deselect() {
   
    // Remove a class named "tabs-item-selected" from the element 
    this.element = this.element.removeClass("tabs-item-selected");
