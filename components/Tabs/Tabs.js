...
class TabLink {
  constructor(element) {
    ...
    this.itemElement = document.querySelector(`.tabs-link[data-tab='${this.element}']`);
  ...
  select() {
    ...
    Array.from(links).forEach( element => {this.element.classList.remove('.tabs-link-selected')});
