class Tabs {
  constructor(element) {
    ...
    // Set the active link to the first item in the array
	 // console.log(this.links.dataset); 
  ...
  getTab(data) {
    ...
    return this.element.querySelector(`.tabs-item[data-tab="${data}"]`);    //this.element
  }
...
class TabsLink {
  ...
  constructor(element, parent) {
   ...
   // console.log(this);	  
    ...
    this.dataN = this.element.dataset.tab;
    this.tabsItem = parent.getTab(this.dataN);	  
