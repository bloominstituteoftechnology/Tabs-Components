...
class Tabs {
  constructor(element) {
    ...
    // No need to update anything here, just study what is going on. Notice that we are creating
    //  another new object using the TabsLink class.
...
class TabsLink {
  ...
  deselect() {
    ...
    this.element.classList.remove('tabs-links-selected'); 
...
// Be sure to pass in a reference to the tab when creating the Tabs object.
