class Tabs {
  constructor(element) {
    ...
    this.links = Array.from(this.links).map( link => {
      return new TabsLink(link, this);  // @QUESTION why do we need return here?
    });
  ...
  getTab(data) {
    ...
    // the parameter here represents the data-tab number.
    // Return the associated Tab item
...
class TabsLink {
  ...
  constructor(element, parent) {
    ...
    //Pass in the data-tab number from the tab-link
