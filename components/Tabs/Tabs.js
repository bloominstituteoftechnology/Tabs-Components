...
class TabsLink {
  ...
  constructor(element, parent) {
    ...
    this.tabsItem = parent.getTab(this.element);
...
class TabsItem {
  constructor(tabNum) {
    let searchString = `.tabs-item[data-tab='${tabNum}']`;         //refactor this
    this.element = document.querySelector(searchString);   //'.tabs-item[data-tab="${tabNum}"]'
  }
