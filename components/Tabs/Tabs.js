...
//============================== Code for trying to create one single Tab Component =============
// class Tab {
//   constructor(tabs) {
//     this.tabs = tabs;
        
//     this.tabsLinkData = this.tabs.dataset.tab;
...
//     this.tabs.addEventListener('click', () => {this.select()});
//   };
...
// const links = document.querySelectorAll('.tabs-link');
// links.forEach( tabs => new TabLink(tabs));