...
class TabItem {
  ...
  select() {
    ...
    Array.from(itemsElements).forEach(itemElement => itemElement.classList.remove("tabs-item-selected"));

    // Add a class named "tabs-item-selected" to this element
    document.querySelector(`.tabs-item[data-tab="${this.data}"]`).classList.add("tabs-item-selected");
  }
}
