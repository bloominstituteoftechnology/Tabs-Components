...
class TabLink {
  constructor(element) {
    ...
    this.itemElement = document.querySelectorAll(`[data-tab="${this.data}"]`);
...
class TabItem {
  ...
  select() {
    ...
    const itemElements = document.querySelectorAll('.tabs-items');
    ...
    this.itemElements.classList.add('tabs-item-selected');
  }
}
