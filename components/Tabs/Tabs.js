class Tabs {
  constructor(element) {
    ...
    this.links = this.element.querySelectorAll(".tabs-link");// create a reference to the ".tabs-link" class nested in your tab object
  ...
  getTab(data) {
    return this.element.querySelector(`.tabs-item[data-tab="${data}"]`);// return a reference to the element's data attribute
  }
}
...
class TabsLink {
  ...
  constructor(element, parent) {
    ...
    this.tabsItem = parent.getTab(this.element.dataset.tab);// Using the method from the parent class above, pass in a reference to the custom data attribute.   
