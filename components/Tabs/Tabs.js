...
class TabLink {
  ...
  select() {
    ...
    // Using a loop or the forEach method remove the 'tabs-link-selected' class from all
    // of the links
...
class TabItem {
  ...
  select() {
    ...
    const itemLinks = document.querySelectorAll('.tabs-item');
...
// DO THIS LAST: Once you have created an array of TabLink instances. call select()
// on the first item in the array
links[0].select();
