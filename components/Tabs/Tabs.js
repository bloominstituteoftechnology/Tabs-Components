...
class TabLink {
  constructor(element) {
    ...
    this.itemElement = Array.from(links[0].children[1].children)[this.data-1]
...
links = Array.from(links[0].children[0].children).map( item => new TabLink(item) );
console.log(links[1].tabItem);
